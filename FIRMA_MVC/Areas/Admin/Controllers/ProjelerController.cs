...
namespace FIRMA_MVC.Areas.Admin.Controllers
{
    public class ProjelerController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PROJE_REFNO,ADI,RESIM,ACIKLAMA")] PROJE pROJE)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PROJE_REFNO,ADI,RESIM,ACIKLAMA")] PROJE pROJE)
        {
            if (ModelState.IsValid)
            {
